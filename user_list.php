	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_user"><i class="fa fa-plus"></i> Thêm tài khoản</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list" >
				...
				<tbody  style="font-weight: lighter !important;">
					<?php
					$i = 1;
					$type = array('',"Admin","Quản lý","Nhân viên");
...
<script>
	...
	$('.view_user').click(function(){
		uni_modal("<i class='fa fa-id-card'></i> Chi tiết tài khoản","view_user.php?id="+$(this).attr('data-id'))
	})
	$('.delete_user').click(function(){
	_conf("Bạn có chắc chắn xóa người dùng này?","delete_user",[$(this).attr('data-id')])
	})
	})
