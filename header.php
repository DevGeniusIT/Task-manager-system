<head>
  ...
  $titles = array(
    'manager_task' => 'Quản lý công việc',
    'manage_user' => 'Quản lý tài khoản',
    'manage_task' => 'Quản lý công việc',
    'new_project' => 'Thêm dự án',
    'view_project' => 'Chi tiết dự án',
    'edit_project' => 'Cập nhật dự án',
    ...
    'reports' => 'Báo cáo',
    // Thêm các tiêu đề tương ứng với các trang khác nếu cần
  );

// Xác định tiêu đề cho trang dựa vào tham số 'page' hoặc mặc định là 'home'
  $page = isset($_GET['page']) ? $_GET['page'] : 'home';
  $title = isset($titles[$page]) ? $titles[$page] : 'Trang chủ';
  ?>
