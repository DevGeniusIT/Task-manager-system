...
<!-- Info boxes -->
 <div class="col-12">
          <div class="card">
            <div class="card-body">
              Xin chào <span style="font-weight: 700;"><?php echo $_SESSION['login_name'] ?></span>!
            </div>
          </div>
  </div>
  <hr>
      ...
      <div class="row">
        ...
        <div class="card card-outline card-success">
          ...
          <div class="card-body p-0">
            <div class="table-responsive" style="padding: 15px 15px 10px 15px;">
                ...
                elseif($row['status'] == 0 && strtotime(date('d-m-Y')) >= strtotime($row['start_date'])):
                  ...
                  <tr>
                      ...
                      <td>
                          ...
                          <br>
                          <small>
                              Đến hạn: <?php echo date("d-m-Y",strtotime($row['end_date'])) ?>
                          </small>
                      </td>
